...
public class Principal {
    ...
    public void exibeMenu() {
        ...
        while(opcao != 0) {
            var menu = """
                    ...
                    10 - Bucar top episodios por serie        
                    11 - Buscar episodio depois de uma data        
                    0 - Sair                                 
                    """;
    ...
    private void topEpisodiosPorSerie() {
        ...
        if(serieBusca.isPresent()){
            ...
            topEpisodios.forEach(e -> System.out.printf("Serie: %s Temporada %s - Episodio %s - %s - Avaliaçao %s\n",
